...
import breakout.GameMapParser;
import breakout.bricks.*;
import breakout.balls.*;

class StandardBrickTest {
    ...
    void testStandardBrick() {
    	assertTrue( brick instanceof StandardBrick);
    ...
    void testConstructorWithInvalidArguments() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new StandardBrick(geometry1, null);
        });
    }
    @Test
    void testStandardBrickHit() {
    	brickWidth = 50;
		brickHeight = 20;
		width = 1000;
		height = 1000;
    ...
    @Test
    void testGetColor() {
        assertEquals(new Color(128, 128, 128), brick.getColor());
    }
}
